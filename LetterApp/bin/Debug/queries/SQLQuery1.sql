select    DISTINCT lc.cod_luna,
                               ...
                               s.exigible as bill, --bill es la deuda por producto???
                               CASE s.COD_SISTEMA
                               WHEN 1 THEN 'FIJA'
                               WHEN 2 THEN 'CABLE'
                               WHEN 3 THEN 'MÓVIL'
                               WHEN 4 THEN 'AMDOCS'
                               END as service, --pusiste servicio, pero en telefónica servicio es un código unico, como los campos los rellenaste con esos datos que en realidad son el "sistema" ps ahí te puse el sistema
...
inner join core_rango_deuda r on l.cod_rango_deuda_avanzada = r.cod_rango_deuda and r.cod_rango_deuda in (5,6) --filtros obligatorio (éste cambiaría cada vez que algún jefe quiera cambiar de estrategia)
--inner join moroso m on m.moroso = l.moroso
...
lc.exigible > 400 
and lc.retiro = 0 
and lc.estadogestioncall = 3 and i.cod_indicador is null 

--filtros seleccionados dentro de la aplicación
--and z.NOMBRE = 'AYA' 
--and lc.Exigible > 1000 
