    ...
    partial class MenuStrip
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkFilterListButtonsControlHost =
                new System.Windows.Forms.ToolStripControlHost(checkFilterListButtonsPanel);
            ...
            this.resizeBoxControlHost =
                new System.Windows.Forms.ToolStripControlHost(new System.Windows.Forms.Control());
            this.SuspendLayout();
            ...
            this.Items.AddRange(
                new ToolStripItem[]
                    {
                        sortASCMenuItem, sortDESCMenuItem, cancelSortMenuItem, toolStripSeparator1MenuItem,
                        cancelFilterMenuItem, customFilterLastFiltersListMenuItem, toolStripSeparator3MenuItem,
                        checkTextFilterControlHost, checkFilterListControlHost, checkFilterListButtonsControlHost,
            ...
            this.customFilterLastFilter1MenuItem.VisibleChanged +=
                new System.EventHandler(customFilterLastFilter1MenuItem_VisibleChanged);
            this.customFilterLastFilter1MenuItem.Click += new System.EventHandler(customFilterLastFilterMenuItem_Click);
            this.customFilterLastFilter1MenuItem.TextChanged +=
                new System.EventHandler(customFilterLastFilterMenuItem_TextChanged);
            ...
            this.customFilterLastFilter2MenuItem.TextChanged +=
                new System.EventHandler(customFilterLastFilterMenuItem_TextChanged);
            ...
            this.customFilterLastFilter3MenuItem.TextChanged +=
                new System.EventHandler(customFilterLastFilterMenuItem_TextChanged);
            ...
            this.customFilterLastFilter4MenuItem.TextChanged +=
                new System.EventHandler(customFilterLastFilterMenuItem_TextChanged);
            ...
            this.customFilterLastFilter5MenuItem.TextChanged +=
                new System.EventHandler(customFilterLastFilterMenuItem_TextChanged);
            ...
            this.customFilterLastFiltersListMenuItem.DropDownItems.AddRange(
                new ToolStripItem[]
                    {
                        customFilterMenuItem, toolStripSeparator2MenuItem, customFilterLastFilter1MenuItem,
                        customFilterLastFilter2MenuItem, customFilterLastFilter3MenuItem,
                        customFilterLastFilter4MenuItem, customFilterLastFilter5MenuItem
                    });
            this.customFilterLastFiltersListMenuItem.MouseEnter +=
                new System.EventHandler(customFilterLastFiltersListMenuItem_MouseEnter);
            this.customFilterLastFiltersListMenuItem.Paint +=
                new System.Windows.Forms.PaintEventHandler(customFilterLastFiltersListMenuItem_Paint);
            ...
            this.button_ok.BackColor = DefaultBackColor;
            ...
            this.button_cancel.BackColor = DefaultBackColor;
            ...
            this.resizeBoxControlHost.MouseDown +=
                new System.Windows.Forms.MouseEventHandler(resizeBoxControlHost_MouseDown);
            this.resizeBoxControlHost.MouseUp +=
                new System.Windows.Forms.MouseEventHandler(resizeBoxControlHost_MouseUp);
            this.resizeBoxControlHost.MouseMove +=
                new System.Windows.Forms.MouseEventHandler(resizeBoxControlHost_MouseMove);
            ...
            this.checkList.Bounds = new System.Drawing.Rectangle(
                4,
                4,
                this.checkFilterListPanel.Width - 8,
                this.checkFilterListPanel.Height - 8);
            ...
            this.checkList.NodeMouseClick +=
                new System.Windows.Forms.TreeNodeMouseClickEventHandler(checkList_NodeMouseClick);
            ...
            this.checkFilterListButtonsPanel.Controls.AddRange(new Control[] { button_ok, button_cancel });
