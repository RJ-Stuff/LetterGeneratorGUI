    ...
    partial class AdvancedDataGridViewSearchToolBar
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Items.AddRange(
                new ToolStripItem[]
                    {
                        this.button_close, this.label_search, this.comboBox_columns, this.textBox_search,
                        this.button_frombegin, this.button_wholeword, this.button_casesensitive, this.separator_search,
                        this.button_search
                    });
